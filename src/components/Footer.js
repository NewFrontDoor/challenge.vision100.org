                  ...
                  <div id="block-block-8" className="block block-block">
                    ...
                    <div className="content">
                      <div className="footer-mail text-center">
                        ...
                        <p><a href="mailto:eventmanager@vision100.org">eventmanager@vision100.org</a><br /></p>
                      </div> {/* /footer-mail */}  </div>
                  </div>  </div>
                  ...
                  <div className="block block-block">
                    ...
                    <div className="content">
                      <div className="footer-phone text-center">
                        ...
                        <p><a href="https://www.facebook.com/challengeconference/" target="_blank" rel="noreferrer noopener">facebook.com/challengeconference</a><br /></p>
                      </div>  </div>
                  </div>  </div>
