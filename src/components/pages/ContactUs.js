...
class ContactUs extends Component {
  ...
  render() {
    ...
    var contactForm = (
      <section>
        <p><em>The below form is currently placeholder only.</em></p>
            ...
            <div className="row">
              <div id="main-content-region" className="main-content col-xs-12 col-md-8 col-md-offset-2">
                ...
                <div id="block-block-54" class="block block-block">
                  ...
                  <div class="content">
                    If you have any questions about Challenge Conference or would like more information on how to get involved, please contact us - we would love to hear from you.  </div>
                </div>
                    ...
                    <div class="contacts">
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 margin-top-xs-40">
                          <h5>Contact Us</h5>
                          <p><b>Facebook:</b> &nbsp;<a href="https://www.facebook.com/challengeconference/" target="_blank" rel="noreferrer noopener">/challengeconference</a><br />
                            <b>Email:</b>&nbsp;<a href="mailto:eventmanager@vision100.org">eventmanager@vision100.org</a></p>
                        </div>
